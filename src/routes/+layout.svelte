<script lang="ts">
	...
	// Accept a string and narrow to 'light'|'dark' to avoid TS errors when passing a plain string
...
<nav class="navbar is-primary" aria-label="main navigation">
	...
	<div class="navbar-menu">
		...
		<div class="navbar-end">
			{#if loggedInUser.token}
				<!-- Theme toggle: placed to the left of the user's name -->
				<div class="navbar-item">
					<button class="theme-toggle" onclick={toggleTheme} aria-label="Toggle theme" aria-pressed={theme === 'dark'}>
